...
class TestDDS(unittest.TestCase):
    ...
    def test_dds_scores(self):
        ...
        # To Do: Move this file to a 'test' directory
        ...
        deal_json = json.loads(deal_string)

        # Disable 'String statement has no effect (pointless-string-statement)' warning
        ...
        dds_table = dds.calc_dd_table(deal_json['hands'])
